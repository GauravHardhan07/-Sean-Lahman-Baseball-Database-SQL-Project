# Project Overview
This project explores the Sean Lahman Baseball Database using SQL to analyze player careers, salaries, teams, and historical trends in Major League Baseball (MLB). The database contains comprehensive baseball statistics spanning over a century, making it ideal for practicing real‑world analytical SQL queries.
The goal of this project is to strengthen SQL skills such as joins, aggregations, window functions, CTEs, and date calculations, while extracting meaningful insights from complex relational data.

# Dataset
Source: Sean Lahman Baseball Database
Contents: Players, Teams, Salaries, Batting, Pitching, Awards, etc.
Time Span: 1871 – recent MLB seasons
...
Gained hands‑on experience with advanced SQL analytics
Learned how to structure readable and maintainable queries
Improved ability to extract insights from large relational datasets
Strengthened understanding of time‑based and trend analysis
